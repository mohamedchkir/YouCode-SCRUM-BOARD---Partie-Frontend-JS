...
function printTasks() {
  ...
  //boucle pour afficher les informations de chaque task
...
function addTask() {
  ...
  button_save.onclick = () => {
    ...
    // Ajouter task dans le tableau alltasks
    allTasks.push(task);
...
function editTask(index) {
  ...
  //condition pour selectionner la boutton selectionner
